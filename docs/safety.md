...
- Use the target's `supportsUnprotect` and `supportsProtect` metadata to validate explicit choices. Do not infer prior protection state or automatically re-protect after writing.
